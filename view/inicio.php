...
<html lang="en">
  ...
  <div class="p-5 bg-light">
    <div class="container">
        ...
        <h1 class="display-3"> Proyecto  </h1>
        <p class="lead"><i class="fas fa-user-clock"></i> Turnos  </p>
        <hr class="my-2">
        <p></p>
        <p class="lead">
            <a class="btn btn-primary btn-lg" href="registrar_asistencia.php" role="button"><i class="fas fa-pencil-alt"></i> REGISTRAR TURNO</a>
        </p>
    </div>
</div>
